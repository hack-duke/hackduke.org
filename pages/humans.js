...
export default function Humans() {
  ...
  const teams = {
    ...
    Design:
      "More than just making things look pretty! But we do enjoy a good deal of pixel-pushing...",
    Logistics:
            ...
            <div className="columns is-desktop is-vcentered">
              ...
              >
                ...
                >
                  ...
                  We are a group of Duke students who work together to bring to
                  life Code for Good and Ideate. Although we all have different
                  interests and backgrounds, we value our community and are
                  united by our passions in building something cool. We are
                  split into 6 teams (Tech, Design, Logistics, Outreach,
                  Sponsorship, Marketing) and are lead by our two amazing
                  co-directors!
                </div>
              </div>
              <div
        ...
        <section className="section is-medium" id="humans-cards">
          <div className="container">
            ...
            >
              ...
              <div className="mb-8 text-[1rem]">"{teams[team]}"</div>
              <TeamCards team={team} />
            </div>
          </div>
        </section>
        <section className="section" id="next-chapters">
          <div className="container pl-[5vw] pr-[5vw]">
            ...
            <div className="subtitle mb-2 font-sans text-[1.25rem] text-black">
              Part of our goal as an organization is to provide our members with
              mentorship, learning, and opportunities to make real impact. This
              desire to grow and help others doesn’t leave us after Hackduke. We
              are proud to have our family go on to do amazing things at great
              companies like the ones below!{" "}
            </div>
            <img
              className="mt-8"
