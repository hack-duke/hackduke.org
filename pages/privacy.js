...
export default function privacy() {
    return (
        <>
            <Head>
                <title>Privacy | HackDuke</title>
            </Head>
            <Navbar color="#0042c6" />
            <section className="flex min-h-[40vh] items-center justify-center bg-[#0042c6] pt-40">
                <div>
                    <div className="mb-8 font-sans text-5xl font-semibold text-white">
                        Privacy Policy
                    </div>
                </div>
            </section>
            <div className="m-6">
                <div className="m-auto block w-full max-w-screen-sm font-sans">
                    <p className="my-5 text-2xl font-semibold text-black">
                        HackDuke Privacy Policy
                    </p>
                    ...
                    <h2 className="my-2 text-base font-semibold text-black">
                        Interpretation
                    </h2>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this
                                Agreement) refers to HackDuke, 100 Fuqua Drive,
                                Durham, NC 27708.
                            </p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>
                                <strong>Country</strong> refers to: North
                    ...
                    <ul>
                        <li>By email: contact@hackduke.org</li>
                    </ul>
                    <p className="mt-4">Last updated: March 01, 2023</p>
                </div>
            </div>
